...
export const ConfigBar: React.FC<Props> = ({ config, onConfigChange, theme, toggleTheme }) => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 px-5 py-3 shadow-soft dark:shadow-dark-soft transition-colors duration-300 surface-grain">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-slate-900 dark:bg-white p-2 rounded-lg">
              <Eye className="text-white dark:text-slate-900" size={20} />
            </div>
            <h1 className="text-xl font-semibold tracking-tight text-slate-900 dark:text-white flex items-baseline gap-2">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => setIsAboutOpen(true)}
              className="p-2 rounded-lg bg-slate-100/80 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 transition-colors"
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg bg-slate-100/80 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 transition-all active:scale-90"
              title="Toggle Theme"
            >
            ...
            <button
              ...
              className="p-2 rounded-lg bg-slate-100/80 dark:bg-slate-800/80 hover:bg-blue-100 dark:hover:bg-blue-900/40 text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
              title="Settings"
            >
              <Settings size={20} />
            </button>
      ...
      {isSettingsOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-xl shadow-soft-lg dark:shadow-dark-soft-lg border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col max-h-[90vh]">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 px-3 py-2.5 rounded-md border border-slate-200 dark:border-slate-700">
                      ...
                      <input
                        ...
                        className="bg-transparent border-none text-sm text-slate-900 dark:text-white focus:outline-none w-full placeholder-slate-400 dark:placeholder-slate-500"
